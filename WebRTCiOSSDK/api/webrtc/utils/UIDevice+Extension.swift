...
//  WebRTCiOSSDK
//
//  Created by Cem Nisan on 19.09.2025.
//
...
extension UIDevice {
    ...
    static let IS_IPHONE_13 = IS_IPHONE && SCREEN_MAX_LENGTH == 844 // 13
    static let IS_IPHONE_12_13_PRO_MAX = IS_IPHONE && SCREEN_MAX_LENGTH == 926 // 12 Pro Max, 13 Pro Max
    
    static let IS_SMALL_SCREEN = UIDevice.IS_IPHONE_4 || UIDevice.IS_IPHONE_5 || UIDevice.IS_IPHONE_6 || UIDevice.IS_IPHONE_6P || UIDevice.IS_IPHONE_XS
}
...
public extension UIDevice {
    ...
    static let devicesThatShouldStartWithUltraWide: [Model] = [
        .iPhone13Pro,
        .iPhone13ProMax
    ]
}
